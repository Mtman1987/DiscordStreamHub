  ...
  return (
    ...
    >
      ...
      {message.forwardedMessageId && (
        <input type="hidden" name="forwardedMessageId" value={message.forwardedMessageId} />
      )}
    ...
    while ((match = combinedRegex.exec(content)) !== null) {
      ...
      if (mention && userId) {
        ...
        if (/\.(gif|jpe?g|png|webp)$/i.test(url)) {
          const optimizedUrl = url.startsWith('https')
